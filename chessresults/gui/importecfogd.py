...
class ImportECFOGD(logpanel.WidgetAndLogPanel):
    ...
    def __init__(
        ...
        **kargs):
        ...
        def _create_ogd_datagrid_widget(master):
            ...
            class OGDimportgrid(exceptionhandler.ExceptionHandler,
                                DataGridReadOnly):
            ...
            try:
                ...
                db = self.datagrid.get_data_source(
                    ).dbhome.main[ecfogddb.PLAYERS]
        ...
        self.get_appsys().get_results_database(
            ).close_database_contexts(closecontexts)
    ...
    def _copy_ogd_players(self, logwidget=None):
        ...
        try:
            ...
            ogdplayers.close()
        self.tasklog.append_text_only(''.join(
