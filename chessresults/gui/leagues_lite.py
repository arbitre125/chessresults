    ...
    def __init__(self, menubar=None, **kargs):
        ...
        self.define_state_transitions(
            ...
            switch_state={
                ...
                (self._state_dbopen,
                 control_lite.Control._btn_importevents
                ...
                (self._state_dbopen,
                 events_lite.Events._btn_exportevents
                 ): [self._state_dbopen_report_event, self._tab_reportevent],
                (self._state_dbopen,
                 events_lite.Events._btn_event_summary
                 ): [self._state_dbopen_report_event, self._tab_reportevent],
                (self._state_dbopen,
                 events_lite.Events._btn_performance
                 ): [self._state_dbopen_report_event, self._tab_reportevent],
                (self._state_dbopen,
                 events_lite.Events._btn_game_summary
                 ): [self._state_dbopen_report_event, self._tab_reportevent],
                (self._state_dbopen,
                 events_lite.Events._btn_prediction
                 ): [self._state_dbopen_report_event, self._tab_reportevent],
                (self._state_dbopen,
                 events_lite.Events._btn_population
                 ): [self._state_dbopen_report_event, self._tab_reportevent],
                (self._state_dbopen_report_event,
    ...
    def database_new(self):
        ...
        if self._database_modulename != _modulename:
            ...
            self._database_class = import_name(
                _modulename, _ResultsDB)
            self._datasourceset_class = import_name(
                self._database_class._datasourceset_modulename,
                _DataSourceSet)
    ...
    def results_close(self):
        ...
        if tkinter.messagebox.askyesno(
            ...
            if self.get_state() in (
                self._state_takeonopen_dbopen, self._state_takeonopen):
