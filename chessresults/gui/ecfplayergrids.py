...
class NewPersonGrid(ECFPlayerGrid):
    ...
    def __init__(self, panel, **kwargs):
        ...
        super(NewPersonGrid, self).__init__(
            panel,
            **kwargs)
...
class PersonGrid(ECFPlayerGrid):
    ...
    def __init__(self, panel, **kwargs):
        """Extend, customise record selection widget, and note sibling grids."""
        super(PersonGrid, self).__init__(
            panel,
            **kwargs)
...
class ECFPersonGrid(ECFPlayerGrid):
    ...
    def __init__(self, panel, **kwargs):
        """Extend, customise record selection widget, and note sibling grids."""
        super(ECFPersonGrid, self).__init__(
            panel,
            **kwargs)
...
class NewPlayerClubGrid(ECFPlayerGrid):
    ...
    def __init__(self, panel, **kwargs):
        """Extend, customise record selection widget, and note sibling grids."""
        super(NewPlayerClubGrid, self).__init__(
            panel,
            **kwargs)
...
class PlayerECFDetailGrid(ECFPlayerGrid):
    ...
    def __init__(self, panel, **kwargs):
        """Extend, customise record selection widget, and note sibling grids."""
        super(PlayerECFDetailGrid, self).__init__(
            panel,
            **kwargs)
...
class ECFClubCodeGrid(ECFPlayerGrid):
    ...
    def __init__(self, panel, **kwargs):
        """Extend, customise record selection widget, and note sibling grids."""
        super(ECFClubCodeGrid, self).__init__(
            panel,
            **kwargs)
