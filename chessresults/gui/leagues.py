...
class Leagues(leagues_lite.Leagues):
    ...
    def __init__(self, master=None, cnf=dict(), **kargs):
        ...
        self.define_tab(
            ...
            underline=5,
            tabclass=lambda **k: ecfevents.ECFEvents(gridhorizontal=False, **k),
            destroy_actions=(control.Control._btn_closedatabase,))
        self.define_tab(
        ...
        self.define_tab(
            ...
            destroy_actions=(ratedplayers.RatedPlayers._btn_closeratedplayers,))
        ...
        self.define_state_transitions(
            ...
            switch_state={
                ...
                (self._state_dbopen,
                 control.Control._btn_copyecfmasterclub
                 ): [self._state_importecfdata, self._tab_importecfdata],
                (self._state_importecfdata,
