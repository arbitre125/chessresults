...
class ImportCollation(gameobjects.GameCollation):
    ...
    def __init__(self, importreport):
        ...
        for k, game in importreport.game.items():
            if (constants._hometeam not in game or
                constants._awayteam not in game):
            ...
            if constants._round in game:
                if constants._board in game:
                    section.games.append(gameobjects.SwissMatchGame(
                    ...
                    section.games.append(gameobjects.SwissGame(
                        round=game[constants._round],
                        result=game[constants._result],
                        date=game[constants._date],
                        homeplayerwhite=hpw,
                ...
                section.games.append(gameobjects.MatchGame(
                    board=game[constants._board],
                    result=game[constants._result],
                    date=game[constants._date],
                    homeplayerwhite=hpw,
                ...
                section.games.append(gameobjects.Game(
                    result=game[constants._result],
                    date=game[constants._date],
                    homeplayerwhite=hpw,
                    homeplayer=hp,
