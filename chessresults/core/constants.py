...
ACTIVE_CLUBS_KEYS = frozenset(
    [A_C_CLUBS, 'success', 'processing_time', 'total_processing_time_today',
     'max_processing_time_daily'])
ACTIVE_CLUBS_ROW_KEY_NAMES = (
    'club_code', 'club_name', 'comment', 'assoc_code', 'assoc_name')
P_R_COLUMN_NAMES = 'column_names'
P_R_PLAYERS = 'players'
PLAYERS_RATINGS_KEYS = frozenset(
    ['rating_effective_date', 'prior_rating_effective_date', P_R_COLUMN_NAMES,
     P_R_PLAYERS, 'success', 'processing_time', 'total_processing_time_today',
     'max_processing_time_daily'])
PLAYERS_RATINGS_COLUMN_NAMES = (
    'ECF_code', 'member_no', 'FIDE_no', 'full_name', 'ECF_junior',
    'FIDE_junior', 'gender', 'nation', 'nation2', 'date_last_game',
    'standard_original_rating', 'standard_revised_rating',
    'standard_category', 'standard_games_12m', 'standard_games_24m',
    'standard_games_36m', 'prior_standard_revised_rating',
    'prior_standard_category', 'rapid_original_rating',
    'rapid_revised_rating', 'rapid_category', 'rapid_games_12m',
    'rapid_games_24m', 'rapid_games_36m', 'prior_rapid_revised_rating',
    'prior_rapid_category', 'club_code', 'club_name')
